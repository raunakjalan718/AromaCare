...
// Threshold values
const int THRESHOLD_MQ135 = 2100;   // Air quality threshold
const int THRESHOLD_MQ136 = 1200;   // Gas detection threshold
const int THRESHOLD_MQ137 = 1300;   // Ammonia threshold
...
void setup() {
  ...
  // Enable library-level CORS for any other routes
